...
public class CardPlayer2 extends Actor
{
    ...
    public CardPlayer2()
    {
        base = new GreenfootImage("CardPlayer2.png");
    ...
    public void act()
    {
        ...
        {
            SelectedCharacter.select(SelectedCharacter.Type.PLAYER2);
            CharacterSelectWorld w = (CharacterSelectWorld) getWorld();
            w.setSelected(SelectedCharacter.Type.PLAYER2);
        }
