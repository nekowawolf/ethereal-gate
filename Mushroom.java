...
public class Mushroom extends Actor {
    ...
    public Mushroom() {
        // ===== LOAD IMAGES =====
        idle = loadImages("Mushroom_Idle", 4);
        run = loadImages("Mushroom_Run", 8);
        attack = loadImages("Mushroom_Attack", 8);
        takeHit = loadImages("Mushroom_TakeHit", 4);
        death = loadImages("Mushroom_Death", 4);
    ...
    GreenfootImage[] loadImages(String folder, int count) {
        ...
        for (int i = 0; i < count; i++) {
            imgs[i] = new GreenfootImage("Mushroom/" + folder + "/" + i + ".png");
